...
public class TS3ConnectionBeginJava
{
  ...
  protected final String TEXT_151 = NL + "\t//This method is just for test connection." + NL + "\tconn_";
  protected final String TEXT_152 = ".getS3AccountOwner();" + NL + "\t";
  protected final String TEXT_153 = NL + "\t\ttry{" + NL + "\t\t\tconn_";
  protected final String TEXT_154 = ".getBucketLoggingConfiguration(\"Check-Connection-Only\");" + NL + "\t}catch(com.amazonaws.AmazonServiceException ase_";
  protected final String TEXT_155 = "){" + NL + "\t\t\tif(ase_";
  protected final String TEXT_156 = ".getErrorCode().equals(\"NoSuchBucket\")){" + NL + "\t\t\t//ignore" + NL + "\t\t\t}else{" + NL + "\t\t\t\t\tthrow ase_";
  protected final String TEXT_157 = ";" + NL + "\t\t\t}" + NL + "\t}" + NL + "\t" + NL + "\t";
